...
def predict_tags():
    ...
    # Charger le fichier CSV à partir de la requête
    csv_file = request.files['file']

    # Lire le fichier CSV avec pandas
    df = pd.read_csv(csv_file)

    # Extraire les colonnes pertinentes pour la prédiction des tags
    body_column = 'Body'
    tags_column = 'Tags'
    ...
    # Vectoriser les textes d'entrée
    ...
    # Créer une liste de dictionnaires pour représenter les prédictions
    predictions = []
